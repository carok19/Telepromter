// Pestaña con forma de flecha, pegada al borde izquierdo de la pantalla,
// reemplazo del botón "Ajustes" del footer. A diferencia del resto de los
...
export function SettingsTab({ open, onClick, hidden = false }: SettingsTabProps) {
  ...
  return (
    <button
      ...
      className="absolute top-1/2 left-0 z-40 flex h-16 w-7 -translate-y-1/2 items-center justify-center rounded-r-md border border-l-0 border-white/10 bg-white/5 text-gray-500 transition-colors hover:bg-white/10 hover:text-gray-300"
    >
